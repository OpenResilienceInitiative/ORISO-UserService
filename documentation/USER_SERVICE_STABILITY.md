...
| --- | ---: | ---: | ---: | ---: | --- |
| Unit | 3,445 | 0 | 0 | 0 | `./mvnw -Dskip.integration-tests=true test` |
| Integration + contract + E2E | 857 | 0 | 0 | 9 | `scripts/ci/run-required-integration-tests.sh` |
...
comparable primary current inventory is therefore 3,445 unit plus 857
integration executions, or 4,302.
...
inventory to the current 4,302: 337 fewer unit and 83 fewer integration
...
map one-to-one to the 420-execution net reduction. This is intentional scope
...
857 executions in 83 reports. The unit workflow applies the same exact-count
gate to all 3,445 unit executions.
...
`a174fab7e6715027d316ea8744f8bf26df055806`: 3,445 unit executions across
394 reports with zero failures, zero errors and no skips, and 857 required
integration executions across 83 reports with zero failures, zero errors and
