  ...
  void claimedIdentityCannotAcquireRolesUntilReactivated() {
    var ds =
        new DriverManagerDataSource(
            "jdbc:h2:mem:rolechange" + java.util.UUID.randomUUID() + ";DB_CLOSE_DELAY=-1",
            "sa",
            "");
    ...
    jdbc.execute(
        "CREATE TABLE IF NOT EXISTS account_inactivity_journal(journal_id BIGINT GENERATED BY"
            + " DEFAULT AS IDENTITY PRIMARY KEY,identity_id VARCHAR(36),action VARCHAR(30),target"
            + " VARCHAR(30),outcome VARCHAR(40),created_at TIMESTAMP(6))");
