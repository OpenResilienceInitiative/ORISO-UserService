...
public class PathConstants {
  ...
  public static final String PATH_PUT_ASSIGN_CHAT = "/users/chat/" + MATRIX_ROOM_ID + "/assign";
  ...
  public static final String PATH_RECORD_SESSION_CONSENT = "/users/sessions/123/consent";
