...
class ScheduledTaskClaimWriterTest {
  ...
  @Test
  void claim_Should_createFirstClaim() {
  ...
  @Test
  void claim_Should_rejectActiveClaim() {
    var activeClaim =
  ...
  @Test
  void claim_Should_renewExpiredClaim() {
    var expiredClaim =
        ScheduledTaskClaim.builder()
            .taskName(TASK_NAME)
  ...
  @Test
  void hasActiveClaim_Should_distinguishActiveAndExpiredClaims() {
    var activeClaim =
        ScheduledTaskClaim.builder()
            .taskName(TASK_NAME)
            .claimedAt(NOW.minusMinutes(5))
