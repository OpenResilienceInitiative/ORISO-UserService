...
/**
 * Violation rule to find consultants without a chat (Matrix) identity. Such a consultant looks
 * identical to a working one in every admin list, and every counselling room operation refuses it.
 */
@Component
